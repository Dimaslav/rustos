...
/// Скан-код → ASCII. Учитывает Shift для верхних символов.
...
/// Очередь нажатых клавиш — сюда кладёт IRQ1, отсюда читает shell.
pub static KEY_QUEUE: Mutex<VecDeque<u8>> = Mutex::new(VecDeque::new());
